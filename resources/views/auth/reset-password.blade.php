    ...
    <div class="w-px-400 mx-auto">
        ...
        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('password.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="{{ request()->route('email') }}" placeholder="Enter your email" readonly />
            </div>
            @error('email')
            ...
            <div class="mb-3 form-password-toggle">
                <label class="fw-500" for="confirm-password">Confirm Password</label>
                <div class="input-group input-group-merge">
