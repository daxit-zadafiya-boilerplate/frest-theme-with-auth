<x-guest-layout page="confirm password">
    <div class="w-px-400 mx-auto">
        ...
        <h4 class="mb-2 mt-3">Confirm Password 🔒</h4>
        <p class="mb-4">This is a secure area of the application. <br />
        ...
        <form id="formAuthentication" class="mb-3" method="POST" action="">
            ...
            <button class="btn btn-primary d-grid w-100 mb-3">Confirm</button>
