<x-guest-layout page="verify email">
    <div class="w-px-400 mx-auto">
        ...
        @endif
        <h4 class="mb-2 mt-1">Verify your email ✉️</h4>
        <p class="text-start">
            Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly send you another.
        </p>
        <form id="formAuthentication" method="POST" action="">
            @csrf
            <button class="btn btn-primary w-100 my-3" type="submit">Resend Verification Email</button>
        </form>
